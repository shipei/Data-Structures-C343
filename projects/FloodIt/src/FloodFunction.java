...
public class FloodFunction {
    ...
    public void flood(final Map color_of_tiles, final Integer color)
    {
    	...
    	while(itor.hasNext())
    	{
    		...
    		if(flooded_list.contains(up(coord)) && color == val)
    		{
    			flooded_list.add(coord);
    		}
    		else if(flooded_list.contains(down(coord)) && color == val)
    		{
    			flooded_list.add(coord);
    		}
    		else if(flooded_list.contains(left(coord)) && color == val)
    		{
    			flooded_list.add(coord);
    		}
    		else if(flooded_list.contains(right(coord)) && color == val)
    		{
    			flooded_list.add(coord);
    		}
    	}
