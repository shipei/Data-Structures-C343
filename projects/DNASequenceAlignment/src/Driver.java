...
public class Driver {
    ...
    public void resize(final int _size) {
       ...
       this.feed(_str1, _str2);
        //this.feed("ATGCTCTTCCTTGTAATAGGCAATT@TCTATTCTTCGCCCTAACTTCTTGA","CGTTTGTGTCGGCTTAGTCACATCA@TTTCATGTCTTACTCAAGCTGCAGC");
    }
    ...
    public static void test() {
        try {
            final FileReader reader = new FileReader("bin/tests.txt");
